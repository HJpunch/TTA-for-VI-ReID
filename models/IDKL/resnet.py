...
class embed_net(nn.Module):
    def __init__(self, drop_last_stride,  decompose=False):
        ...
        self.shared_module_fr = Shared_module_fr(drop_last_stride=drop_last_stride, modality_attention=0
                                                 )
        self.shared_module_bh = Shared_module_bh(drop_last_stride=drop_last_stride, modality_attention=0
                                                 )

        self.special = Special_module(drop_last_stride=drop_last_stride, modality_attention=0)
